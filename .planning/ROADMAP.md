...
| 9.1 Journal-Backfill und Betriebs-Härtung | v3.0 | 8/8 | **Complete — verifiziert 3/3.** Aufgeteilt (Plan 14-07): Backfill in Plan 14-10 erledigt (26.08.2026), WR-07 durch Plan 14-02 geschlossen. Code-Härtung WR-02–WR-05 in 8 Plänen / 6 Wellen ausgeführt: `busy_timeout` zentral mit Nebenläufigkeitstest (WR-03), Testabdeckung `overtime_comp` (WR-02), `server/scripts/**` typisiert und 13 Legacy-Skripte entfernt (WR-04), Nachtlauf in den Serverprozess verlagert (WR-05). Auf Staging und Produktion ausgeliefert und dort gemessen. D-17 belegt: zwei volle Nächte unter derselben PID ohne `(deleted)`-Dateizeiger und ohne 03:00-Stempel. Code-Review (4 Blocker / 16 Warnungen / 8 Hinweise) in den Quick Tasks `260830-cg6` und `260831-t5j` bis auf dokumentierte Restpunkte geschlossen, ausgeliefert am 02.09.2026 (Serverstand `4d8b3de`) | 2026-09-02 |
...
| 14. Absicherung und Auslieferung | v3.0 | 9/11 | **Ausgeliefert — ein Plan offen.** 14-01 bis 14-08 und 14-11 (Release v1.9.0) abgeschlossen. 14-10 (Journal-Backfill) ist **sachlich** erledigt, aber nicht als Plan gefahren: der Vollaufbau `--all-months` lief am 26.08. im Rahmen der Auslieferung gegen die Produktion (+991 Journalzeilen, 0 Bewegung im angezeigten Saldo, danach 15 von 15 Nutzern deckungsgleich mit dem kanonischen Rechenweg — `14-AUSLIEFERUNG.md`, Abschnitt 5). **14-09 erledigt (Stand 02.09.2026).** Der reale Umstellungsfall ist eingetragen: Benedikt Jochem (userId 16), 30 → 40 h/Woche zum Stichtag 01.08.2026, vom Anwender am 27.08.2026 11:33 in der Desktop-App gesetzt statt über `applyModelChange.ts` — das Produkt trägt den Fall, nicht ein Wartungsskript. `14-UMSTELLUNGSFALL.md` existiert (181 Zeilen); die beiden dort zunächst offen geführten Belegpunkte sind am 02.09.2026 gegen eine geprüfte Sicherung geschlossen (Abschnitte 7.1 und 7.2): genau EINE `model_change`-Buchung im gesamten Journal, genau EIN Nutzer mit zwei Perioden, Wortlaut und Betrag (−28 h) festgehalten. Kernwert an realen Daten belegt: Juli rechnet weiter mit 30 h (138 h Soll = 23 × 6), August mit 40 h (168 h Soll = 21 × 8) — die Vergangenheit blieb stehen | 2026-08-26 |
